...
export const InstancesTable: React.FC<InstancesTableProps> = ({ id, instanceDetails, heading, description }) => {
    return (
        <div>
            <Text style={{ textAlign: 'left', fontSize: 16, color: '#C9190B', fontWeight: 'bold'}}>{heading}</Text>
            <Text style={{ fontSize: 14, textAlign: 'left', marginBottom: 4 }}>{description}</Text>

            <div style={{ display: 'flex', flexDirection: 'row' }}>
                <Text style={{ width: 140, fontSize: 14, color: '#6A6E73', paddingBottom: 4 }}>Instance type</Text>
                <Text style={{ width: 120, fontSize: 14, color: '#6A6E73', paddingBottom: 4 }}>
                    # of { id === 'historical_instance_types' ? 'times' : 'systems'}
                </Text>
                <Text style={{ flex: 1, fontSize: 14, color: '#6A6E73', paddingBottom: 4}}>Description</Text>
