export const complianceData = {
      ...
      testResultProfiles: [
        {
          ...
          rules: [
            {
              compliant: true,
              identifier: "{\"label\":\"CCE-27274-0\",\"system\":\"https://nvd.nist.gov/cce/index.cfm\"}",
            ...
            {
              compliant: true,
              identifier: "{\"label\":\"CCE-27399-5\",\"system\":\"https://nvd.nist.gov/cce/index.cfm\"}",
            ...
            {
              compliant: false,
              identifier: "{\"label\":\"CCE-80645-5\",\"system\":\"https://nvd.nist.gov/cce/index.cfm\"}",
            ...
            {
              compliant: true,
              identifier: "{\"label\":\"CCE-80226-4\",\"system\":\"https://nvd.nist.gov/cce/index.cfm\"}",
              refId: "xccdf_org.ssgproject.content_rule_sshd_enable_x11_forwarding",
              remediationAvailable: true,
              severity: "high",
        ...
        policies: [
          {
            ...
            tags: [
              {namespace: 'PuukZ', key: 'RzHWTAc', value: 'YIYqvTJZu', __typename: 'Tag'},
              {namespace: 'juHKRCj', key: 'haEEd', value: 'uklSAGD', __typename: 'Tag'},
              {namespace: 'HBLfOaezC', key: 'rxfAzVkba', value: 'IOuGO', __typename: 'Tag'},
              {namespace: 'oFcZHfcDT', key: 'iJexDAHdX', value: 'UFIVttug', __typename: 'Tag'},
              {namespace: 'VUDEInCgcR', key: 'DUrWtYS', value: 'kxqNK', __typename: 'Tag'},
            ],
          testResultProfiles: [
            {
              compliant: false,
              ...
              rules: [
                ...
                {
                  compliant: false,
                  identifier: "{\"label\":\"CCE-27336-7\",\"system\":\"https://nvd.nist.gov/cce/index.cfm\"}",
                  refId: "xccdf_org.ssgproject.content_rule_service_rlogin_disabled",
                  remediationAvailable: true,
                  severity: "high",
                ...
                {
                  compliant: false,
                  identifier: "{\"label\":\"CCE-27337-5\",\"system\":\"https://nvd.nist.gov/cce/index.cfm\"}",
  ...
  unsupportedSystems: [
    ...
    testResultProfiles: [{
      ...
      rules: [
        {
          compliant: true,
          identifier: "{\"label\":\"CCE-27012-4\",\"system\":\"https://nvd.nist.gov/cce/index.cfm\"}",
          refId: "xccdf_org.ssgproject.content_rule_chronyd_or_ntpd_specify_multiple_servers",
  ...
  policy: {
    ...
    policyType: "PCI-DSS v3.2.1 Control Baseline for Red Hat Enterprise Linux 7",
    refId: "xccdf_org.ssgproject.content_profile_pci-dss",
    ssgVersion: "0.1.57",
  ...
  topTenFailedRules: [
    { 
      compliant: false,
      identifier: "{\"label\":\"CCE-26876-3\",\"system\":\"https://nvd.nist.gov/cce/index.cfm\"}",
    ...
    {
      compliant: false,
      identifier: "{\"label\":\"CCE-27157-7\",\"system\":\"https://nvd.nist.gov/cce/index.cfm\"}",
    ...
    {
      compliant: false,
      identifier: "{\"label\":\"CCE-27209-6\",\"system\":\"https://nvd.nist.gov/cce/index.cfm\"}",
    ...
    {
      compliant: false,
      identifier: "{\"label\":\"CCE-27286-4\",\"system\":\"https://nvd.nist.gov/cce/index.cfm\"}",
    ...
    {
      compliant: false,
      identifier: "{\"label\":\"CCE-27407-6\",\"system\":\"https://nvd.nist.gov/cce/index.cfm\"}",
    ...
    {
      compliant: false,
      identifier: "{\"label\":\"CCE-26989-4\",\"system\":\"https://nvd.nist.gov/cce/index.cfm\"}",
    ...
    {
      compliant: false,
      identifier: "{\"label\":\"CCE-26957-1\",\"system\":\"https://nvd.nist.gov/cce/index.cfm\"}",
    ...
    {
      compliant: false,
      identifier: "{\"label\":\"CCE-26818-5\",\"system\":\"https://nvd.nist.gov/cce/index.cfm\"}",
    ...
    {
      compliant: false,
      identifier: "{\"label\":\"CCE-81004-4\",\"system\":\"https://nvd.nist.gov/cce/index.cfm\"}",
    ...
    {
      compliant: false,
      identifier: "{\"label\":\"CCE-27433-2\",\"system\":\"https://nvd.nist.gov/cce/index.cfm\"}",
